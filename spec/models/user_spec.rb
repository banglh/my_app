...
describe User do
	before { @user = User.new(name: "Example name", email: "example@mail.com",
...
# test the presence of name and email
...
# test if the new email address is existed in database
	describe "when email is taken before" do
		before do
...
# test password authentication
	...
	describe "return value for authentication method" do
		before {@user.save}
